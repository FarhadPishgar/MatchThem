...
#' @name mimipo
#'
#' @description \code{mimipo} object contains data of multiply imputed pooled outcome. \code{mimipo} objects are generated by calls to \code{pool()}.
#'
#' @details \code{mimipo} objects has methods for the \code{print()} and \code{summary()} functions (please see \pkg{mice} package reference manual for description of arguments of these functions).
#'
