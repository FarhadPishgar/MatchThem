...
#' @name mimids
#'
#' @description The \code{mimids} object contains data of matched multiply imputed datasets. The \code{mimids} object is generated by calls to the \code{matchthem()} function.
#'
