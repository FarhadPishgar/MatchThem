...
#'
#' @details \code{wimids} objects has methods for the \code{print()}, \code{summary()}, and \code{merge()} functions (please see \pkg{WeightIt} package reference manual for details).
#'
