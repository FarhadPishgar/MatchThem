...
#' @name wimids
#'
#' @description \code{wimids} object contains data of weighted multiply imputed datasets. The \code{wimids} object is generated by calls to the \code{weightthem()}.
#'
#' @details \code{wimids} objects has methods for the \code{print()}, \code{summary()}, and \code{merge()} functions (please see \pkg{WeightIt} package reference manual for description of arguments of these functions).
#'
