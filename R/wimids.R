#' @title Weighted Multiply Imputed Dataset
#'
#' @docType class
#'
#' @aliases wimids
...
#' @name wimids
#'
#' @description The \code{wimids} object contains data of weighted multiply imputed datasets. The \code{wimids} object is generated by calls to the \code{weightthem()} function.
#'
#' @details The \code{wimids} objects has methods for the \code{print()} and \code{summary()} functions.
#'
