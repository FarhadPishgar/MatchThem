...
[![](https://img.shields.io/badge/CRAN%20version-3.0.1-orange.svg?color=yellow&style=for-the-badge)](https://cran.r-project.org/package=MatchThem)
[![](https://img.shields.io/badge/github%20version-3.0.2-orange.svg?color=yellow&style=for-the-badge)](https://github.com/FarhadPishgar/MatchThem)
...
2. **Matching the Imputed Datasets**: The `matchitmice()` function from the [`MatchThem`](https://cran.r-project.org/package=MatchThem) package should be used to select matched observations from treatment and control groups of each imputed dataset.
